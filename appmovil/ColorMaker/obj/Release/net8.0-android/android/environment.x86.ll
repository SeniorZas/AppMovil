...
@dso_cache = dso_local local_unnamed_addr global [504 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 582228546, ; hash 0x22b41a42, from name: aot-ColorMaker
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 975989477, ; hash 0x3a2c6ae5, from name: aot-ColorMaker.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ColorMaker.dll.so
		ptr null; void* handle (0x0)
	}, ; 105
	...
	%struct.DSOCacheEntry {
		i64 1257381912, ; hash 0x4af22018, from name: libaot-ColorMaker.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ColorMaker.dll.so
		ptr null; void* handle (0x0)
	}, ; 135
	...
	%struct.DSOCacheEntry {
		i64 1640309514, ; hash 0x61c5230a, from name: ColorMaker.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ColorMaker.dll.so
		ptr null; void* handle (0x0)
	}, ; 182
	...
	%struct.DSOCacheEntry {
		i64 3266707121, ; hash 0xc2b5feb1, from name: ColorMaker
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ColorMaker.dll.so
		ptr null; void* handle (0x0)
	}, ; 393
	...
	%struct.DSOCacheEntry {
		i64 3866827901, ; hash 0xe67b1c7d, from name: libaot-ColorMaker
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ColorMaker.dll.so
		ptr null; void* handle (0x0)
	}, ; 451
